...
from .views import news_list, news_detail, home_page_view, ContactPageView, error_page_view, HomePageView, LocalNewsView, ForeignNewsView, TechnologyNewsView, SportNewsView
